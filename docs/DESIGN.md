...
Mouse left/right aims. Holding RMB and moving horizontally sets bank from -45° hyzer to +45° anhyzer; release retains the angle. A useful flat snap makes neutral effortless. Holding LMB locks aim and bank, then downward mouse travel draws power like a bow. Release throws. This is displacement, never a hold timer. Cancel with RMB/Esc. No swing timing meter, accuracy RNG, grip, nose-angle control, spin control or simulator inputs. Spin, release loft and launch speed derive automatically from the shot.
